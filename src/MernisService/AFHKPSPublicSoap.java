...
public class AFHKPSPublicSoap
{
    ...
    public AFHKPSPublicSoap(){}

    public AFHKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public AFHKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        AFHExtendedSoapSerializationEnvelope envelope= new AFHExtendedSoapSerializationEnvelope(AFHExtendedSoapSerializationEnvelope.VER11);
