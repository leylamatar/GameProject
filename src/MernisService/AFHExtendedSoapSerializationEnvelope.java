...
public class AFHExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(AFHDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new AFHStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static AFHDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static AFHDateTimeConverter dateTimeConverter = new AFHStandardDateTimeConverter();

    public AFHExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public AFHExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new AFHMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=AFHHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,AFHExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=AFHHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
